    ...
    <section className="ledger-section" id="ledger">
      ...
      <div style={{ maxWidth: 1440, margin: '0 auto' }}>
        <div className="section-head" style={{ borderTopColor: 'var(--paper)' }}>
          ...
          <div>
            <div className="mono reveal" style={{ fontSize: 11, color: 'var(--accent)', letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 500, marginBottom: 12 }}>
            ...
            }}>Twelve IOUs. <i style={{ color: 'var(--accent)' }}>Three</i> payments.</h2>
